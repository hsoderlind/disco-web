...
export const Icon: FC<IconProps> = ({ width = '1em' }) => {
	return (
		<span role='img' className='anticon' aria-label='Discogs'>
			<svg
				version='1.1'
				...
				focusable={false}
				aria-hidden
				className={classes['discogs-icon']}
				width={width}>
	...
	c0-8.1-6.6-14.7-14.7-14.7l0,0C46.2,39.5,39.6,46.1,39.6,54.2L39.6,54.2z'
		...
		C22.1,87,22.4,87.3,22.7,87.6z'
				...
				<g>
					<path className='discogs-icon' d='M17.1,93.7' />
					<path className='discogs-icon' d='M28.2,101.8' />
					<path
