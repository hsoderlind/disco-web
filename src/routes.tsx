			...
			<Route element={<RouteChange />}>
				<Route element={<MainLayout />}>
					...
					<Route path='/:urlAlias' lazy={() => import('./pages/shop/LoadingPage')}>
						...
						<Route path='shipping-methods' handle={{ menuKey: 'shipping-methods' }}>
							<Route path='' lazy={() => import('./pages/shipping-methods')}>
								<Route path=':name' lazy={() => import('./pages/shipping-methods/edit')} />
							</Route>
						...
						<Route path='orders' handle={{ menuKey: 'orders' }}>
							...
							<Route path='order-totals' handle={{ menuKey: 'orders/order-totals' }}>
								<Route path='' lazy={() => import('./pages/order/order-total')}>
									<Route path=':name' lazy={() => import('./pages/order/order-total/edit')} />
								</Route>
